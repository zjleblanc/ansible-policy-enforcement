...
test_allow_empty_extra_vars if {
	...
	aap_policy_examples.team_based_extra_vars_restriction.allowed == true with input as test_input
	aap_policy_examples.team_based_extra_vars_restriction.violations == [] with input as test_input
}
...
test_reject_dev_team_prod_environment if {
	...
	aap_policy_examples.team_based_extra_vars_restriction.allowed == false with input as test_input
	aap_policy_examples.team_based_extra_vars_restriction.violations == ["extra_vars contain disallowed values for keys: [\"environment\"]. Allowed extra_vars for your teams ({\"dev_team\"}): {\"dev_team\": {\"environment\": [\"dev\", \"staging\"]}}"] with input as test_input
}
...
test_reject_prod_team_dev_environment if {
	...
	aap_policy_examples.team_based_extra_vars_restriction.allowed == false with input as test_input
	aap_policy_examples.team_based_extra_vars_restriction.violations == ["extra_vars contain disallowed values for keys: [\"environment\"]. Allowed extra_vars for your teams ({\"prod_team\"}): {\"prod_team\": {\"environment\": [\"prod\", \"staging\"]}}"] with input as test_input
}
...
test_reject_non_team_member if {
	...
	aap_policy_examples.team_based_extra_vars_restriction.allowed == false with input as test_input
	aap_policy_examples.team_based_extra_vars_restriction.violations == ["extra_vars contain disallowed values for keys: [\"environment\"]. Allowed extra_vars for your teams ({\"other_team\"}): {}"] with input as test_input
}
